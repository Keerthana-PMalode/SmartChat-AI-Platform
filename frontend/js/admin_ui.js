...
function showContentPanel(section) {
  ...
  console.log("Hidden class after remove:", panel.classList.contains("hidden"));
...
EventBus.on("chat-history:loaded", (e) => {
  const chats = e.detail?.chats;
